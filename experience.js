const experienceArray = [
  {
    "designation": "SDE (JG5) - Azure & Full Stack",
    "tenure": "Oct 2023 - Present",
    "organisation": "Shell",
    "projects": [
      {
        "title": "Digital Transformation of Trading and Supply applications",
        "descriptions": [
          "Owned module feature development end-to-end, from requirement gathering to production deployment",
          "Implemented Aggregation computing Engine of Power Trading portfolio Data with CQRS design pattern to achieve microservice based Event Driven Architecture",
          "Led developing shared Components ,10 major pages in React JS ,Generic ControlTable Structures,Charts and patterns and animated interactions to optimize User Experience",
          "Led code reviews to ensure adherence to best practices, maintainability, and performance standards",
          "Created cost-optimized GitHub Actions pipelines by minimizing unnecessary workflow runs and leveraging reusable jobs to reduce CI/CD expenses.",
          "Narrowed down the cost of azure infrastructure by rearranging the Azure resources and implementing cost-effective solutions",
          "Participated in cost effective Database system design for Azure Cosmos DB and created Change Feed systems by using Azure Functions to handle denormalization and Data Synchronization among containers",
          "Led and mentored small teams for writing good quality code in React JS",
